...
const MarksModal2 = ({ isOpen, onClose, student }) => {
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-400">
                        Updated by: {m.updatedBy?.name || "Admin"}
                      </p>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <input
                          ...
                          value={m.marks}
                          onChange={(e) =>
                            handleUpdateMark(m._id, e.target.value)
                          }
                        />
                        <span className="absolute -right-6 top-1/2 -translate-y-1/2 text-xs font-bold text-gray-400">
                          /100
                        </span>
                      </div>
                    </div>
